...
import scr from '../../imgs/kinematics-scr.webp';
...
canvasContainer.addEventListener('click', (e) => {
  if (e.target.hasAttribute('data-expanded')) {
...
let browser;
// Mobile variables 
const displayCharts = simScreen.querySelectorAll('.chart');
const chartsDisplayBtns = simScreen.querySelector('.charts-btns-container');
